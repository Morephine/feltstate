...
class TraitConfig:
    ...
    baseline_pull: dict = field(default_factory=lambda: {
...
class PressureConfig:
    ...
    power_weights: dict = field(default_factory=lambda: {
        "optimism": 0.32, "depression_inv": 0.27, "anxiety_inv": 0.16,
        "safety": 0.15, "closeness": 0.10,
    })
    ...
    release_duration_min: dict = field(default_factory=lambda: {
        "tears": (5, 15), "anger": (1, 3), "anxious": (5, 10),
        "withdraw": (30, 60), "burst_joy": (2, 5), "collapse": (10, 20),
    })
    aftertaste_duration_min: dict = field(default_factory=lambda: {
        "tears": 30, "anger": 45, "anxious": 20,
        "withdraw": 60, "burst_joy": 15, "collapse": 90,
    })


# Which pressure bar each release expresses, and its suppressed counterpart.
BAR_TO_RELEASE = {
    "sadness": "tears", "anger": "anger", "anxiety": "anxious",
    "boundary": "withdraw", "joy": "burst_joy",
}
BAR_TO_RELEASE_SUPPRESS = {
    "sadness": "tears_suppress", "anger": "anger_suppress", "anxiety": "anxious_suppress",
    "boundary": "withdraw_suppress", "joy": "burst_joy_suppress",
}
...
DEFAULT_LABELS = (
    "focused", "curious", "content", "amused", "joyful", "excited", "proud",
    "grateful", "calm", "relieved", "hopeful", "tender",
    "sad", "lonely", "tired", "numb", "disappointed", "wistful",
    "anxious", "worried", "scared", "tense", "restless",
    "frustrated", "irritated", "angry", "indignant",
    "embarrassed", "surprised", "confused", "neutral",
)

# label -> {bar: per-turn increment}. Multiple labels onto one bar take max(),
# so they never double-count.
LABEL_TO_PRESSURE = {
    "sad": {"sadness": 0.013}, "lonely": {"sadness": 0.013}, "tired": {"sadness": 0.006},
    "numb": {"sadness": 0.008}, "disappointed": {"sadness": 0.010}, "wistful": {"sadness": 0.005, "joy": 0.003},
    "anxious": {"anxiety": 0.013}, "worried": {"anxiety": 0.010}, "scared": {"anxiety": 0.013},
    "tense": {"anxiety": 0.011}, "restless": {"anxiety": 0.008},
    "frustrated": {"anger": 0.015}, "irritated": {"anger": 0.010},
    "angry": {"anger": 0.015}, "indignant": {"anger": 0.012},
    "curious": {"joy": 0.008}, "focused": {"joy": 0.004}, "hopeful": {"joy": 0.008},
    "content": {"joy": 0.012}, "amused": {"joy": 0.020}, "joyful": {"joy": 0.025},
    "excited": {"joy": 0.025}, "proud": {"joy": 0.020}, "grateful": {"joy": 0.015},
    "calm": {"joy": 0.006}, "relieved": {"joy": 0.010}, "tender": {"joy": 0.012},
    "embarrassed": {"anxiety": 0.007}, "surprised": {"anxiety": 0.012, "joy": 0.012},
    "confused": {"anxiety": 0.006},
}

# label -> {trait: signal in [0,1]} fed to the trait EWMA. max() per trait.
LABEL_TO_TRAITS = {
    "sad": {"depression": 1.0}, "lonely": {"depression": 0.9}, "tired": {"depression": 0.7},
    "numb": {"depression": 0.8}, "disappointed": {"depression": 0.7},
    "anxious": {"anxiety": 1.0}, "worried": {"anxiety": 0.8}, "scared": {"anxiety": 1.0},
    "tense": {"anxiety": 0.8}, "restless": {"anxiety": 0.6},
    "frustrated": {"depression": 0.4, "anxiety": 0.4},
    "joyful": {"optimism": 1.0}, "excited": {"optimism": 0.9}, "content": {"optimism": 0.7},
    "hopeful": {"optimism": 0.9}, "grateful": {"optimism": 0.7}, "proud": {"optimism": 0.7},
    "amused": {"optimism": 0.6}, "relieved": {"optimism": 0.5},
    "curious": {"curiosity": 1.0}, "focused": {"curiosity": 0.6}, "surprised": {"curiosity": 0.5},
}
